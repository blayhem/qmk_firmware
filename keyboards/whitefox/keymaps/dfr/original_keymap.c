...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = LAYOUT(                                                                                                                                                                               \
        RALT(KC_GRV),      KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     MC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,             KC_BSLS,  RALT(KC_GRV),  TG(2),    \
    ...
    [2] = LAYOUT( \
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  _______,  _______,  _______,  _______,  _______,            KC_WH_U,  \
        _______,  KC_WH_U,  KC_WH_D,  KC_BTN2,  KC_BTN1,  _______,  KC_MS_L,  KC_MS_D,  KC_MS_U,  KC_MS_R,  _______,  _______,  _______,  _______,            KC_WH_D,  \
